    ...
    <footer className="bg-bg-secondary border-t border-border">
      <div className="container-wide py-10">
        ...
        <div className="pt-6 border-t border-border text-xs text-fg-muted space-y-2">
          <p>
            This website provides general information about TN visas for educational purposes only.
            It is not legal advice. Consult a qualified immigration attorney for your situation.
            Some links are affiliate links.{' '}
            <Link href="/disclosure" className="underline hover:text-fg-secondary">
              Disclosure
            </Link>
            {' · '}
            <Link href="/about" className="underline hover:text-fg-secondary">
              About
            </Link>
          </p>
          <p>
            © {new Date().getFullYear()} TN Visa Guide · Built in Canada 🇨🇦 ·{' '}
            <a
