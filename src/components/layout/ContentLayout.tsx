...
/* Hallmark · macrostructure: Long Document · designed-as-app: design.md
 * theme: maple-ink modern-minimal · content family
 */
	...
	return (
		<div className="section-padding">
			<div className="max-w-3xl mx-auto">
				...
				<p className="text-fg-secondary text-lg mb-10 text-pretty">
					{description}
				</p>
