...
export default function TNVisaDenied2026() {
  return (
    ...
    >
      <JsonLd data={{ '@context': 'https://schema.org', '@type': 'Article', headline: 'TN Visa Denied? What To Do Next (2026 Guide)', datePublished: '2026-05-09', dateModified: '2026-05-09', author: { '@type': 'Organization', name: 'TN Visa Guide' } }} />
