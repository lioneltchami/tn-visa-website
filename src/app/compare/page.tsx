  ...
  return (
    ...
    >
      <ComparisonTable
        ...
        rows={[
          { label: 'Processing Time', values: ['Same day at border', 'Several months'] },
          { label: 'Annual Cap', values: ['No cap', "65,000 + 20,000 (master's)"] },
          { label: 'Lottery', values: ['No lottery required', 'Subject to lottery (~25% chance)'] },
          { label: 'Duration', values: ['3 years, renewable indefinitely', '6 years max (extendable with GC pending)'] },
          { label: 'Cost', values: ['From $50', '$2,000-$10,000+'] },
          { label: 'Employer Change', values: ['New application at border (same day)', 'New petition required (months)'] },
          { label: 'Dual Intent', values: ['No (single intent only)', 'Yes (can pursue green card)'] },
          { label: 'Eligible Countries', values: ['Canada and Mexico only', 'All countries'] },
          { label: 'Professions', values: ['63 specific professions', 'Any specialty occupation'] },
          { label: 'Self-Employment', values: ['Prohibited', 'Prohibited'] },
          { label: 'Dependents Work', values: ['TD cannot work', 'H-4 EAD available (with conditions)'] },
          { label: 'Green Card Path', values: ['Indirect (must manage intent)', 'Direct (dual intent allowed)'] },
        ]}
      />
