	...
	return (
		...
		>
			...
			<p className="mx-auto max-w-3xl text-center text-base leading-relaxed text-fg-secondary">
				Choose only what you need. Every kit turns scattered requirements into a
				practical preparation workflow you can review, customize, and take with
				you.
			</p>
			...
			<Callout type="info" title="100% Digital Delivery">
				All products are delivered instantly as downloadable PDF files after
				purchase. No physical shipping.
			</Callout>
			...
			<Callout type="tip" title="Not ready to buy? Start free.">
				...
				. The paid kits are for applicants who want the preparation work already
				organized.
			</Callout>
		</ContentLayout>
	);
