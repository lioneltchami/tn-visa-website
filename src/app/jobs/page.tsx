      ...
      <div className="container-wide">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-fg-secondary max-w-3xl mb-3">TN visa jobs are U.S. positions offered to Canadian or Mexican citizens in one of the 63 USMCA professions. This board lists openings tagged with a USMCA profession category so you can filter by profession and location. A TN offer is a U.S. employer hiring you into an eligible profession, not an H-1B lottery. Confirm the category on the <Link href="/professions" className="text-accent hover:underline">professions list</Link>, and confirm fees on the <Link href="/fees" className="text-accent hover:underline">fees page</Link>.</p>
            <p className="text-fg-secondary">Each listing is tagged to a USMCA profession. Still verify duties and credentials against that category before you apply.</p>
          </div>
